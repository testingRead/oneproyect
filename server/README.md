...
correcto recupera el mismo `player_id`. La primera etapa tiene una sala fija de
cinco; `RoomManager` permite varias salas dentro del proceso cuando se añada la
selección de sala.
