...
## Identidad y victorias

El perfil genera un identificador aleatorio de instalación y almacena las
victorias multijugador por separado. El preset Android activa
